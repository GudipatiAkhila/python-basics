...
# Here I am giving start index as 0 if we mention 1 starting index it will print from there  and it will print from starting to end even without mentioning end-index
simple_slice = servers[0:]
print(simple_slice)
#o/p: ['172.10.33.25', '172.10.33.26', True, 123, 123.67]

simple_slice = servers[:4]  # eventhough i am not mentioning any starting index it will take from by default starting and it will print upto 3 indexing as [0,1,2,3] 4th index value should not print 
print(simple_slice)
# output : ['172.10.33.25', '172.10.33.26', True, 123]

simple_slice = servers[:] # I'm not mentioned any startindex and endindex values it will print entire list 
print(simple_slice)
# output : ['172.10.33.25', '172.10.33.26', True, 123, 123.67]
simple_slice = servers[-3:]
print(simple_slice)  # output : [True, 123, 123.67]
...
# we can copy the servers list as servers_1 here if we want to make any changes we can perform here it will not effect to the servers 
